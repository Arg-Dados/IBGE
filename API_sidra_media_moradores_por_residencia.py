...
@app.route('/getAmostra/ibge/sidra/media_moradores_por_residencia', methods=['GET'])
def getAmostra():

    url_api = 'https://apisidra.ibge.gov.br/values/T/156/P/1991,2000,2010/V/619/N1/1'
    response = requests.get(url_api)
    dados = response.json()

    dados_sidra = RetornoSidra(dados)
    list_colunas = [dados_sidra.get_nn(), dados_sidra.get_d1n(), dados_sidra.get_valores(),  dados_sidra.get_mn()]
...
url_api = 'https://apisidra.ibge.gov.br/values/T/156/P/1991/V/619/N1/1'
response = requests.get(url_api)
dados = response.json()
