...
@app.route('/getAmostra/ibge/sidra/percentual_domicilios_posse_de_bens', methods=['GET'])
def getAmostra():

    url_api = 'https://apisidra.ibge.gov.br/values/T/6677/P/2016,2017,2018,2019,2022/V/10250/C845/47552,47553,47554,47555,47556/N1/1'
