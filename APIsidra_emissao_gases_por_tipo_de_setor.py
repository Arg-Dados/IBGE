...
@app.route('/getAmostra/ibge/sidra/emissao_gases_por_tipo_de_industria', methods=['GET'])
def getAmostra():

    url_api = 'https://apisidra.ibge.gov.br/values/T/5911/P/1990,1991,1992,1993,1994,1995,1996,1997,1998,1999,2000,2001,2002,2003,2004,2005,2006,2007,2008,2009,2010,2011,2012,2013,2014/C12898/119121,119122,119123,119124,119125,119126/C12897/119110,119111,119112/N1/1'
    response = requests.get(url_api)
    dados = response.json()

    dados_sidra = RetornoSidra(dados)
    list_colunas = [dados_sidra.get_nn(), dados_sidra.get_d1n(), dados_sidra.get_d2n(), dados_sidra.get_d3n(), dados_sidra.get_valores(),  dados_sidra.get_mn()]
...
url_api = 'https://apisidra.ibge.gov.br/values/T/5911/P/1990/C12898/119121,119122,119123,119124,119125,119126/C12897/119110,119111,119112/N1/1'
response = requests.get(url_api)
dados = response.json()
