...
@app.route('/getAmostra/ibge/sidra/material_predominante_paredes', methods=['GET'])
def getAmostra():

    url_api = 'https://apisidra.ibge.gov.br/values//T/6822/P/2022,2019,2018,2017,2016/V/9784/C338/7983,45903,45904,45905/N1/1'
